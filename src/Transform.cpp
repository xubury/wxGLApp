...
void Transform::setEulerAngle(glm::vec3 eulerAngle)
{
    ...
    right.x = cos(eulerAngle.y) * cos(eulerAngle.z) + sin(eulerAngle.x) * sin(eulerAngle.y) * sin(eulerAngle.z);
    right.y = cos(eulerAngle.x) * sin(eulerAngle.z);
    right.z = -cos(eulerAngle.z) * sin(eulerAngle.y) + cos(eulerAngle.y) * sin(eulerAngle.x) * sin(eulerAngle.z);
